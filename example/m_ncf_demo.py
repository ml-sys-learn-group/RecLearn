...
flags.DEFINE_list("hidden_units", [256, 128, 64], "A list of MLP hidden units.")
...
flags.DEFINE_boolean("use_batch_norm", False, "Whether using batch normalization or not.")
